...
- main.py: contains two functions for calculating the mandelbrot set both slow (pure python) and fast (using c++ wiht pybind11). It times both functions using timeit, and uses pillow to draw.
